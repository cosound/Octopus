...
public class TaskCompleteSpecification {
  private final AllocationHandler allocationHandler;
  private final ConcurrentJobQueue jobsWithUpdates;

  public TaskCompleteSpecification(AllocationHandler allocationHandler, ConcurrentJobQueue jobsWithUpdates) {
  ...
  public void invoke(String json) {
    ...
    try {
      ...
      allocationHandler.taskComplete(task);
